...
public final class JavaFileTest {
    ...
    @Test
    public void importGlobalWildcardReplace() throws Exception {
        String source = JavaFile.builder("",
                TypeSpec.classBuilder("HelloWorld")
                        .addMethod(MethodSpec.methodBuilder("main")
                                .addModifiers(Modifier.PUBLIC, Modifier.STATIC)
                                ...
                                .build())
                        .build())
                .packageWildcardReplace(JavaFile.WILDCARD_REPLACE_ALWAYS)
                .build()
                .toString();
        assertThat(source).isEqualTo(""
                + "import java.lang.*;\n"
    ...
    @Test
    public void importWildcardHint() throws Exception {
        String source = JavaFile.builder("com.squareup.tacos",
                TypeSpec.classBuilder("Taco")
                        .addField(Date.class, "madeFreshDate")
                        .addField(Currency.class, "testCurrency")
                        .build())
                .addImportWildcardHint("java.util", 2)
                .build()
                .toString();
        assertThat(source).isEqualTo(""
                + "package com.squareup.tacos;\n"
